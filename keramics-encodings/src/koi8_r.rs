...
//! KOI8-R encoding.
//!
//! Provides support for encoding and decoding KOI8-R.

use keramics_core::ErrorTrace;

/// KOI8-R decoder.
pub struct DecoderKoi8R<'a> {
...
impl<'a> Iterator for DecoderKoi8R<'a> {
                ...
                if *byte_value < 0x80 {
                    ...
                    match Self::BASE_0X80[(*byte_value - 0x80) as usize] {
                        ...
                        None => Some(Err(keramics_core::error_trace_new!(format!(
                            "Unable to decode KOI8-R: 0x{:02x} as Unicode",
                            *byte_value
                        )))),
                    }
                }
...
impl<'a> Iterator for EncoderKoi8R<'a> {
                        ...
                        match Self::BASE_0X0410[(*code_point as u32 - 0x0410) as usize] {
                            ...
                            None => {
                                return Some(Err(keramics_core::error_trace_new!(format!(
                                    "Unable to encode code point: U+{:04x} as KOI8-R",
                                    *code_point as u32
                                ))));
                            }
                        }
...
mod tests {
    ...
    fn test_decode() -> Result<(), ErrorTrace> {
        ...
        let mut decoder: DecoderKoi8R = DecoderKoi8R::new(&byte_string);
    ...
    fn test_encode() -> Result<(), ErrorTrace> {
        ...
        let mut encoder: EncoderKoi8R = EncoderKoi8R::new(&code_points);
