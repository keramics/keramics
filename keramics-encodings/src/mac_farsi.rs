...
//! MacFarsi encoding.
//!
//! Provides support for encoding and decoding MacFarsi.

use keramics_core::ErrorTrace;

/// MacFarsi decoder.
pub struct DecoderMacFarsi<'a> {
...
impl<'a> DecoderMacFarsi<'a> {
    const BASE_0X80: [u16; 128] = [
        ...
        0x060c, 0x002d, 0x002e, 0x002f, 0x06f0, 0x06f1, 0x06f2, 0x06f3, 0x06f4, 0x06f5, 0x06f6,
        0x06f7, 0x06f8, 0x06f9, 0x003a, 0x061b, 0x003c, 0x003d, 0x003e, 0x061f, 0x274a, 0x0621,
...
impl<'a> Iterator for DecoderMacFarsi<'a> {
...
impl<'a> EncoderMacFarsi<'a> {
    ...
    const BASE_0X0608: [Option<&'static [u8]>; 80] = [
        None,
        None,
        None,
        None,
    ...
    const BASE_0X0668: [Option<&'static [u8]>; 88] = [
        None,
        None,
        Some(&[0xa5]),
        None,
    ...
    const BASE_0X06F0: [Option<&'static [u8]>; 16] = [
        Some(&[0xb0]),
        Some(&[0xb1]),
        Some(&[0xb2]),
        Some(&[0xb3]),
...
impl<'a> Iterator for EncoderMacFarsi<'a> {
...
mod tests {
    ...
    fn test_decode() -> Result<(), ErrorTrace> {
        ...
        let mut decoder: DecoderMacFarsi = DecoderMacFarsi::new(&byte_string);
