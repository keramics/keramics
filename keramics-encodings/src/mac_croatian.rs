...
impl<'a> DecoderMacCroatian<'a> {
    const BASE_0X80: [u16; 128] = [
        ...
        0x2211, 0x220f, 0x0161, 0x222b, 0x00aa, 0x00ba, 0x03a9, 0x017e, 0x00f8, 0x00bf, 0x00a1,
        ...
        0xf8ff, 0x00a9, 0x2044, 0x20ac, 0x2039, 0x203a, 0x00c6, 0x00bb, 0x2013, 0x00b7, 0x201a,
        ...
        match self.code_points.get(self.code_point_index) {
            Some(code_point) => {
                ...
                match *code_point {
                    ...
                    0x00a0..0x0118 => match Self::BASE_0X00A0[(*code_point - 0x00a0) as usize] {
