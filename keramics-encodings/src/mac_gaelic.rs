...
impl<'a> DecoderMacGaelic<'a> {
    const BASE_0X80: [u16; 128] = [
        ...
        0x00a8, 0x2260, 0x00c6, 0x00d8, 0x1e02, 0x00b1, 0x2264, 0x2265, 0x1e03, 0x010a, 0x010b,
        0x1e0a, 0x1e0b, 0x1e1e, 0x1e1f, 0x0120, 0x0121, 0x1e40, 0x00e6, 0x00f8, 0x1e41, 0x1e56,
        0x1e57, 0x027c, 0x0192, 0x017f, 0x1e60, 0x00ab, 0x00bb, 0x2026, 0x00a0, 0x00c0, 0x00c3,
        0x00d5, 0x0152, 0x0153, 0x2013, 0x2014, 0x201c, 0x201d, 0x2018, 0x2019, 0x1e61, 0x1e9b,
        0x00ff, 0x0178, 0x1e6a, 0x20ac, 0x2039, 0x203a, 0x0176, 0x0177, 0x1e6b, 0x00b7, 0x1ef2,
        0x1ef3, 0x204a, 0x00c2, 0x00ca, 0x00c1, 0x00cb, 0x00c8, 0x00cd, 0x00ce, 0x00cf, 0x00cc,
        ...
        match self.code_points.get(self.code_point_index) {
            Some(code_point) => {
                ...
                match *code_point {
                    ...
                    0x00a0..0x0110 => match Self::BASE_0X00A0[(*code_point - 0x00a0) as usize] {
