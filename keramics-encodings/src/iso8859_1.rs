...
impl<'a> Iterator for DecoderIso8859_1<'a> {
...
impl<'a> Iterator for EncoderIso8859_1<'a> {
...
mod tests {
    ...
    fn test_decode() -> Result<(), ErrorTrace> {
        ...
        let mut decoder: DecoderIso8859_1 = DecoderIso8859_1::new(&byte_string);
    ...
    fn test_encode() -> Result<(), ErrorTrace> {
        ...
        let mut encoder: EncoderIso8859_1 = EncoderIso8859_1::new(&code_points);
