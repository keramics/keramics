...
//!
//! Provides support for encoding and decoding ISO-8859-11.

use keramics_core::ErrorTrace;

/// ISO-8859-11 decoder.
pub struct DecoderIso8859_11<'a> {
...
impl<'a> Iterator for DecoderIso8859_11<'a> {
                ...
                if *byte_value < 0xa0 {
                    ...
                    match Self::BASE_0XA0[(*byte_value - 0xa0) as usize] {
                        ...
                        None => Some(Err(keramics_core::error_trace_new!(format!(
                            "Unable to decode ISO-8859-11: 0x{:02x} as Unicode",
                            *byte_value
                        )))),
                    }
                }
...
/// ISO-8859-11 encoder.
pub struct EncoderIso8859_11<'a> {
    /// Code points.
    code_points: &'a [u32],
...
impl<'a> Iterator for EncoderIso8859_11<'a> {
...
mod tests {
    ...
    fn test_decode() -> Result<(), ErrorTrace> {
        ...
        let mut decoder: DecoderIso8859_11 = DecoderIso8859_11::new(&byte_string);
    ...
    fn test_encode() -> Result<(), ErrorTrace> {
        ...
        let mut encoder: EncoderIso8859_11 = EncoderIso8859_11::new(&code_points);
