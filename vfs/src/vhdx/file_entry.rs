    ...
    pub fn get_sub_file_entry_by_index(
        ...
        match self {
            ...
            VhdxFileEntry::Root { image } => {
                let vhdx_layer: VhdxLayer = image.get_layer_by_index(sub_file_entry_index)?;
...
mod tests {
    ...
    fn test_name() -> io::Result<()> {
        ...
        let vhdx_layer: VhdxLayer = vhdx_image.get_layer_by_index(0)?;
