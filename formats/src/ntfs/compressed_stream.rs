...
impl Read for NtfsCompressedStream {
    /// Reads data.
...
impl Seek for NtfsCompressedStream {
...
mod tests {
    ...
    fn get_test_mft_attribute_data() -> Vec<u8> {
        return vec![
            ...
            0x00, 0x00, 0x11, 0x02, 0x00, 0x01, 0x0e, 0x00, 0x00,
        ];
    }
    ...
    fn test_seek_and_read() -> io::Result<()> {
        ...
        assert_eq!(&data, expected_data[1024..1536].as_bytes());
