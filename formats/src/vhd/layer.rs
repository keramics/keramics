...
impl VhdLayer {
    /// Creates a new layer.
    pub(super) fn new(file: &Rc<RefCell<VhdFile>>, identifier: &Uuid, media_size: u64) -> Self {
        Self {
            file: file.clone(),
