...
impl VfsDataStream for NtfsBlockStream {
...
mod tests {
    ...
    fn test_open() -> io::Result<()> {
        let file: File = File::open("../test_data/ntfs/ntfs.raw")?;
        let data_stream: VfsDataStreamReference = SharedValue::new(Box::new(file));
