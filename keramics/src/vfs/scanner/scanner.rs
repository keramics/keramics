    ...
    fn scan_for_sub_nodes(
        ...
        match &scan_node.path {
            ...
            VfsPath::Gpt { .. } => {
                ...
                gpt_volume_system.open(file_system, path)?;
            ...
            VfsPath::Mbr { .. } => {
                ...
                mbr_volume_system.open(file_system, path)?;
            ...
            VfsPath::Qcow { .. } => {
                ...
                qcow_image.open(file_system, path)?;
            ...
            VfsPath::Vhd { .. } => {
                ...
                vhd_image.open(file_system, path)?;
            ...
            VfsPath::Vhdx { .. } => {
                ...
                vhdx_image.open(file_system, path)?;
...
mod tests {
    ...
    fn test_scan_for_file_system_format_with_ext() -> io::Result<()> {
        ...
        let vfs_data_stream: VfsDataStreamReference = get_data_stream("../test_data/ext/ext2.raw")?;
        let vfs_path_type: VfsPathType = format_scanner
    ...
    fn test_scan_for_file_system_format_with_ntfs() -> io::Result<()> {
        ...
        let vfs_data_stream: VfsDataStreamReference =
            get_data_stream("../test_data/ntfs/ntfs.raw")?;
        let vfs_path_type: VfsPathType = format_scanner
            .scan_for_file_system_format(&vfs_data_stream)?
            .unwrap();
    ...
    fn test_scan_for_storage_media_image_format_with_qcow() -> io::Result<()> {
        ...
        let vfs_data_stream: VfsDataStreamReference =
            get_data_stream("../test_data/qcow/ext2.qcow2")?;
        let vfs_path_type: VfsPathType = format_scanner
            .scan_for_storage_media_image_format(&vfs_data_stream)?
            .unwrap();
    ...
    fn test_scan_for_volume_system_format_with_apm() -> io::Result<()> {
        ...
        let vfs_data_stream: VfsDataStreamReference = get_data_stream("../test_data/apm/apm.dmg")?;

        let vfs_path_type: VfsPathType = format_scanner
            .scan_for_volume_system_format(&vfs_data_stream)?
            .unwrap();
    ...
    fn test_scan_for_volume_system_format_with_gpt() -> io::Result<()> {
        ...
        let vfs_data_stream: VfsDataStreamReference = get_data_stream("../test_data/gpt/gpt.raw")?;
    ...
    fn test_scan_for_volume_system_format_with_mbr() -> io::Result<()> {
        ...
        let vfs_data_stream: VfsDataStreamReference = get_data_stream("../test_data/mbr/mbr.raw")?;
