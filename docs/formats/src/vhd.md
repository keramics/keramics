...
| 16 | 8 | | Block allocation table offset, which contains the offset to the block allocation table structure. The offset is relative from the start of the file |
