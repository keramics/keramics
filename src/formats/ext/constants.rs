...
/// ext incompatible features flags
pub const EXT_INCOMPATIBLE_FEATURES_FLAG_HAS_META_BLOCK_GROUPS: u32 = 0x00000010;
pub const EXT_INCOMPATIBLE_FEATURES_FLAG_64BIT_SUPPORT: u32 = 0x00000080;
pub const EXT_INCOMPATIBLE_FEATURES_FLAG_HAS_FLEX_BLOCK_GROUPS: u32 = 0x00000200;
pub const EXT_INCOMPATIBLE_FEATURES_FLAG_HAS_METADATA_CHECKSUM_SEED: u32 = 0x00002000;

/// ext read-only compatible features flags
pub const EXT_READ_ONLY_COMPATIBLE_FEATURES_FLAG_SPARSE_SUPERBLOCK: u32 = 0x00000001;
pub const EXT_READ_ONLY_COMPATIBLE_FEATURES_FLAG_METADATA_CHECKSUM: u32 = 0x00000400;
