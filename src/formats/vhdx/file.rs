...
impl VhdxFile {
    ...
    fn read_metadata(&mut self) -> io::Result<()> {
        ...
        secondary_image_header
            .read_at_position(&self.data_stream, io::SeekFrom::Start(2 * 65536))?;
        ...
        primary_region_table.read_at_position(&self.data_stream, io::SeekFrom::Start(3 * 65536))?;

        let mut secondary_region_table: VhdxRegionTable = VhdxRegionTable::new();

        secondary_region_table
            .read_at_position(&self.data_stream, io::SeekFrom::Start(4 * 65536))?;
        ...
        self.read_metadata_values(metadata_region)?;
    ...
    fn read_metadata_values(&mut self, metadata_region: &VhdxRegionTableEntry) -> io::Result<()> {
