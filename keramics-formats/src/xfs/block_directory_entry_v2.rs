...
/// X File System (XFS) block directory entry version 2.
pub struct XfsBlockDirectoryEntryV2 {
    /// Inode number.
...
mod tests {
    ...
    fn test_read_data() -> Result<(), ErrorTrace> {
        ...
        let mut test_struct = XfsBlockDirectoryEntryV2::new();
