...
#[layout_map(
    structure(
        ...
        field(name = "free_regions", data_type = "[u8; 12]"),
    ),
    methods("debug_read_data")
)]
/// X File System (XFS) directory tree leaf header.
pub struct XfsDirectoryTreeLeafHeader {
    /// Number of entries.
    pub number_of_entries: u16,
}

impl XfsDirectoryTreeLeafHeader {
...
mod tests {
    ...
    fn get_test_data() -> Vec<u8> {
        // TODO: replace by non synthetic test data
        vec![
    ...
    fn test_read_data() -> Result<(), ErrorTrace> {
        ...
        let mut test_struct = XfsDirectoryTreeLeafHeader::new();
