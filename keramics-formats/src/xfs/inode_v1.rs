...
#[layout_map(
    structure(
        ...
        field(name = "unknown1", data_type = "[u8; 14]"),
...
/// X File System (XFS) inode version 1.
pub struct XfsInodeV1 {}
...
impl XfsInodeV1 {
    ...
    pub fn read_data(inode: &mut XfsInode, data: &[u8]) -> Result<(), ErrorTrace> {
        ...
        inode.number_of_links = bytes_to_u16_be!(data, 6) as u32;
...
mod tests {
    ...
    fn test_read_data() -> Result<(), ErrorTrace> {
        ...
        XfsInodeV1::read_data(&mut test_struct, &test_data)?;
    ...
    fn test_read_data_with_unsupported_data_size() {
        ...
        let mut test_struct = XfsInode::new();
        let result = XfsInodeV1::read_data(&mut test_struct, &test_data[0..99]);
    ...
    fn test_read_data_with_unsupported_signature() {
        ...
        let mut test_struct = XfsInode::new();
        let result = XfsInodeV1::read_data(&mut test_struct, &test_data);
        assert!(result.is_err());
    }
