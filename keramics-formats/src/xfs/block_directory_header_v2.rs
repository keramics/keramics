...
/// X File System (XFS) block directory header version 2.
pub struct XfsBlockDirectoryHeaderV2 {}

impl XfsBlockDirectoryHeaderV2 {
...
mod tests {
    ...
    fn test_read_data() -> Result<(), ErrorTrace> {
        ...
        let mut test_struct = XfsBlockDirectoryHeaderV2::new();
