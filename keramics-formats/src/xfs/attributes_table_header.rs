...
/// X File System (XFS) attributes table header.
pub struct XfsAttributesTableHeader {
    /// Data size.
    pub data_size: u16,
...
impl XfsAttributesTableHeader {
    ...
    pub fn read_data(&mut self, data: &[u8]) -> Result<(), ErrorTrace> {
        ...
        self.data_size = bytes_to_u16_be!(data, 0);
        self.number_of_entries = data[2];
...
mod tests {
    ...
    fn test_read_data() -> Result<(), ErrorTrace> {
        ...
        let mut test_struct = XfsAttributesTableHeader::new();
        test_struct.read_data(&test_data)?;

        assert_eq!(test_struct.data_size, 108);
