...
/// X File System (XFS) extended attribute.
pub struct XfsExtendedAttribute {
    /// The name.
    name: ByteString,
...
mod tests {
    ...
    fn test_get_data_stream() {
        ...
        let test_struct: XfsExtendedAttribute = XfsExtendedAttribute::new(&test_name, data_stream);
