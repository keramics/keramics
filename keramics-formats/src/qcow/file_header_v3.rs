...
impl QcowFileHeaderV3 {
    ...
    pub fn read_data(file_header: &mut QcowFileHeader, data: &[u8]) -> Result<(), ErrorTrace> {
        ...
        if file_header.header_size != 104 && file_header.header_size != 112 {
            return Err(keramics_core::error_trace_new!(format!(
...
mod tests {
    ...
    fn test_read_data() -> Result<(), ErrorTrace> {
        ...
        QcowFileHeaderV3::read_data(&mut test_struct, &test_data)?;
    ...
    fn test_read_data_with_unsupported_data_size() {
        ...
        let mut test_struct = QcowFileHeader::new();
        let result = QcowFileHeaderV3::read_data(&mut test_struct, &test_data[0..103]);
