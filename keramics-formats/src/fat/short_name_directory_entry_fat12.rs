...
/// File Allocation Table (FAT-12 or FAT-16) short name directory entry.
pub struct Fat12ShortNameDirectoryEntry {}

impl Fat12ShortNameDirectoryEntry {
...
mod tests {
    ...
    fn test_read_data() -> Result<(), ErrorTrace> {
        ...
        Fat12ShortNameDirectoryEntry::read_data(&mut test_struct, &test_data)?;
    ...
    fn test_read_data_with_unsupported_data_size() {
        ...
        let mut test_struct: FatShortNameDirectoryEntry = FatShortNameDirectoryEntry::new();
        let result = Fat12ShortNameDirectoryEntry::read_data(&mut test_struct, &test_data[0..31]);
