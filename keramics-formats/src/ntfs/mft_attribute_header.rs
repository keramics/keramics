...
#[layout_map(
    structure(
        ...
        field(name = "attribute_size", data_type = "u32"),
        field(name = "non_resident_flag", data_type = "u8", format = "hex"),
        field(name = "name_size", data_type = "u8"),
        field(name = "name_offset", data_type = "u16"),
        field(name = "data_flags", data_type = "u16", format = "hex"),
