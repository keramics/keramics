...
#[layout_map(
    structure(
        byte_order = "little",
        field(name = "substitute_name_offset", data_type = "u16"),
        field(name = "substitute_name_size", data_type = "u16"),
        field(name = "display_name_offset", data_type = "u16"),
        field(name = "display_name_size", data_type = "u16"),
    ),
...
impl NtfsJunctionReparseData {
    ...
    pub fn read_data(&mut self, data: &[u8]) -> Result<(), ErrorTrace> {
        ...
        let data_offset: usize = (display_name_offset as usize) + 8;
...
mod tests {
    ...
    fn get_test_data() -> Vec<u8> {
        return vec![
            0x03, 0x00, 0x00, 0xa0, 0x34, 0x00, 0x00, 0x00, 0x00, 0x00, 0x18, 0x00, 0x1a, 0x00,
            0x10, 0x00, 0x5c, 0x00, 0x3f, 0x00, 0x3f, 0x00, 0x5c, 0x00, 0x43, 0x00, 0x3a, 0x00,
    ...
    fn test_read_data() -> Result<(), ErrorTrace> {
        let mut test_struct: NtfsJunctionReparseData = NtfsJunctionReparseData::new();
        ...
        assert_eq!(
            ...
            Ucs2String::from("\\??\\C:\\Users")
        );
        assert_eq!(test_struct.display_name, Ucs2String::from("C:\\Users"));
