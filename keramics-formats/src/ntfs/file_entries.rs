...
/// New Technologies File System (NTFS) file entries iterator.
pub struct NtfsFileEntriesIterator<'a> {
    /// File entry.
    file_entry: &'a mut NtfsFileEntry,
...
impl<'a> NtfsFileEntriesIterator<'a> {
    /// Creates a new iterator.
    pub fn new(file_entry: &'a mut NtfsFileEntry) -> Self {
        Self {
            file_entry,
...
impl<'a> Iterator for NtfsFileEntriesIterator<'a> {
    type Item = Result<NtfsFileEntry, ErrorTrace>;
