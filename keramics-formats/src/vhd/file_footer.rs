...
#[layout_map(
    structure(
        ...
        field(name = "creator_application", data_type = "ByteString<4>"),
        field(name = "creator_version", data_type = "[u16; 2]"),
        field(name = "creator_operating_system", data_type = "ByteString<4>"),
        field(name = "disk_size", data_type = "u64"),
        field(name = "data_size", data_type = "u64"),
        field(name = "disk_geometry", data_type = "u32", format = "hex"),
