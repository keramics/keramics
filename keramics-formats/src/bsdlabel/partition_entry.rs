...
/// BSD disklabel (bsdlabel) partition entry.
pub struct BsdDiskLabelPartitionEntry {
    /// The entry index.
    pub entry_index: u16,
...
impl BsdDiskLabelPartitionEntry {
...
mod tests {
    ...
    fn test_read_data() -> Result<(), ErrorTrace> {
        ...
        let mut test_struct = BsdDiskLabelPartitionEntry::new();
