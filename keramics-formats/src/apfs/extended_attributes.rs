...
/// Apple File System (APFS) extended attributes iterator.
pub struct ApfsExtendedAttributesIterator<'a> {
    /// File entry.
    file_entry: &'a mut ApfsFileEntry,
...
impl<'a> ApfsExtendedAttributesIterator<'a> {
    /// Creates a new iterator.
    pub fn new(file_entry: &'a mut ApfsFileEntry) -> Self {
        Self {
            file_entry,
...
impl<'a> Iterator for ApfsExtendedAttributesIterator<'a> {
    type Item = Result<ApfsExtendedAttribute, ErrorTrace>;
