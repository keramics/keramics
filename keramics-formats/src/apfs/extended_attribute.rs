...
/// Apple File System (APFS) extended attribute.
...
mod tests {
    ...
    fn test_get_data_stream() {
        ...
        let test_struct: ApfsExtendedAttribute =
            ApfsExtendedAttribute::new(&test_name, data_stream);
