...
/// Apple File System (APFS) file system key with name.
pub struct ApfsFileSystemKeyWithName {
    /// Data type.
    pub data_type: u8,
...
impl ApfsFileSystemKeyWithName {
    /// Creates a new key.
    pub fn new() -> Self {
        Self {
            data_type: 0,
    ...
    pub fn read_data(&mut self, data: &[u8]) -> Result<(), ErrorTrace> {
        ...
        self.name_size = bytes_to_u16_le!(data, 8);
...
mod tests {
    ...
    fn get_test_data() -> Vec<u8> {
        vec![
            0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x90, 0x09, 0x00, 0x74, 0x65, 0x73, 0x74,
    ...
    fn test_read_data() -> Result<(), ErrorTrace> {
        ...
        let mut test_struct = ApfsFileSystemKeyWithName::new();
