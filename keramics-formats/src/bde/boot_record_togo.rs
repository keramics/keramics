...
#[layout_map(
    structure(
        ...
        field(name = "bootcode", data_type = "[u8; 334]", format = "hex"),
        ...
        field(name = "unknown3", data_type = "[u8; 46]", format = "hex"),
        field(name = "boot_signature", data_type = "[u8; 2]", format = "hex"),
    ),
    methods("debug_read_data")
)]
/// BitLocker Drive Encryption (BDE) boot record used by BitLocker ToGo.
pub struct BdeBootRecordToGo {
    /// Bytes per sector.
...
impl BdeBootRecordToGo {
    ...
    pub fn read_data(&mut self, data: &[u8]) -> Result<(), ErrorTrace> {
        ...
        if &data[424..440] != BDE_IDENTIFIER {
        ...
        self.metadata_block_offset1 = bytes_to_u64_le!(data, 440);
        self.metadata_block_offset2 = bytes_to_u64_le!(data, 448);
        self.metadata_block_offset3 = bytes_to_u64_le!(data, 456);
...
mod tests {
    ...
    fn get_test_data() -> Vec<u8> {
        vec![
            0xeb, 0x58, 0x90, 0x4d, 0x53, 0x57, 0x49, 0x4e, 0x34, 0x2e, 0x31, 0x00, 0x02, 0x01,
            0x20, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0xf8, 0x00, 0x00, 0x3f, 0x00, 0xff, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0xf8, 0x03, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x01, 0x00, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x29, 0xcf, 0x70, 0x8c,
            0x53, 0x4e, 0x4f, 0x20, 0x4e, 0x41, 0x4d, 0x45, 0x20, 0x20, 0x20, 0x20, 0x46, 0x41,
            ...
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x0e, 0x06, 0x80, 0xb5, 0x8a, 0x77, 0x57, 0x40, 0xb3, 0x9a, 0xe3, 0xdf,
            0x8e, 0x81, 0xb1, 0xa1, 0x3b, 0xd6, 0x67, 0x49, 0x29, 0x2e, 0xd8, 0x4a, 0x83, 0x99,
            0xf6, 0xa3, 0x39, 0xe3, 0xd0, 0x01, 0x00, 0x00, 0x10, 0x02, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x58, 0xb5, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0xb0, 0x5a, 0x03, 0x00, 0x00,
            0x00, 0x00, 0x72, 0x53, 0x76, 0x44, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x78, 0x78,
    ...
    fn test_read_data() -> Result<(), ErrorTrace> {
        ...
        let mut test_struct = BdeBootRecordToGo::new();
        ...
        assert_eq!(test_struct.metadata_block_offset2, 0x02b55800);
        assert_eq!(test_struct.metadata_block_offset3, 0x035ab000);
