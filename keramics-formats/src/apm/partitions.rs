...
pub struct ApmPartitionsIterator<'a> {
    /// Volume system.
...
impl<'a> ApmPartitionsIterator<'a> {
    /// Creates a new iterator.
    pub fn new(volume_system: &'a ApmVolumeSystem, number_of_partitions: usize) -> Self {
        Self {
            volume_system,
...
impl<'a> Iterator for ApmPartitionsIterator<'a> {
    type Item = Result<ApmPartition, ErrorTrace>;
